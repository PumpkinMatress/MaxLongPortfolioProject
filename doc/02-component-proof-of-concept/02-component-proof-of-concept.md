...
I chose to go with PrintQueue (filament based). I chose filament-based because I think its
a really interesting way to approach the issue, and the other ones I explored (FIFO, Priority),
seemed like less interesting issues.
